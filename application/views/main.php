...
<!-- 				</li> -->
				...
				<li class="heading">
					<h3 class="uppercase">更多</h3>
				</li>
				<li>
					<a href="javascript:;">
					<i class="icon-logout"></i>
					<span class="title">实用工具</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
				...
				<li class="last ">
					...
					<span class="title">网页地图</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li>
			...
			<div class="row ">
				<div class="col-md-6 col-sm-6">
					<div class="portlet box purple-wisteria">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-calendar"></i>访问数据
							</div>
							<div class="actions">
				...
				<div class="col-md-6 col-sm-6">
					<div class="portlet box red-sunglo">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-calendar"></i>服务状态
							</div>
							<div class="tools">
								<a href="" class="collapse">
								</a>
...
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/jquery.vmap.js"?> type="text/javascript"></script>
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js"?> type="text/javascript"></script>
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js"?> type="text/javascript"></script>
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js"?> type="text/javascript"></script>
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js"?> type="text/javascript"></script>
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js"?> type="text/javascript"></script>
<script src=<?=base_url()."static/public/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js"?> type="text/javascript"></script>
